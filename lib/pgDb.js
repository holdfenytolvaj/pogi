...
class PgDb extends queryAble_1.QueryAble {
    ...
    initSchemasAndTables() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let r of schemas_and_tables.rows) {
                ...
                this.schemas[r.schema].tables[r.name] = new pgTable_1.PgTable(this.schemas[r.schema], r);
    ...
    initFieldTypes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.setPgDbTypeParser('int8', numWithValidation); //int8 - 20
            yield this.setPgDbTypeParser('float8', numWithValidation); //float8 - 701
            yield this.setPgDbTypeParser('_int8', stringArrayToNumWithValidation);
            yield this.setPgDbTypeParser('_float8', stringArrayToNumWithValidation);
        });
    }
    /**
