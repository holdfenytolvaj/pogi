...
class PgTable extends queryAble_1.QueryAble {
    ...
    find(conditions, options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            let sql = `SELECT ${pgUtils_1.pgUtils.processQueryFields(options, this)} FROM ${this.qualifiedName} ${where.where} ${pgUtils_1.pgUtils.processQueryOptions(options, this)}`;
    ...
    findAll(options) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            options = options || {};
            let sql = `SELECT ${pgUtils_1.pgUtils.processQueryFields(options, this)} FROM ${this.qualifiedName} ${pgUtils_1.pgUtils.processQueryOptions(options, this)}`;
