...
class PgTable extends queryAble_1.QueryAble {
    ...
    ;
    upsert(record, columnsOrConstraintName, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            options = options || {};
            if (!record) {
                throw new Error("insert should be called with data");
    ...
    ;
    upsertAndGet(record, columnsOrConstraintName, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            options = options || {};
            if (!record) {
                throw new Error("insert should be called with data");
    ...
    getUpsertQuery(record, columnsOrConstraintName, options) {
        options = options || {};
        options.skipUndefined = options.skipUndefined === true || (options.skipUndefined === undefined && this.db.config.skipUndefined === 'all');
        ...
        if (Array.isArray(columnsOrConstraintName)) {
            sql += " ON CONFLICT (" + columnsOrConstraintName.map(c => pgUtils_1.pgUtils.quoteField(c)).join(', ') + ") DO UPDATE SET " + snipplet;
        }
        else {
