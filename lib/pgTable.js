...
class PgTable extends queryAble_1.QueryAble {
    constructor(schema, desc) {
        let fieldType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    find(conditions, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sql = 'SELECT' + pgUtils_1.pgUtils.processQueryFields(options) + ' FROM ' + this.qualifiedName + (where.where ? where.where : '') + pgUtils_1.pgUtils.processQueryOptions(options);
