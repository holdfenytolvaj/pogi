...
describe("pgdb", () => {
    ...
    it("Exception on name collision", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("After adding parser should be able to parse complex type", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Complex type could be easily read and converted to json", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({
    ...
    it("List for a non array column in the condition should be converted to 'IN Array'", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing where function", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'Fulig Jimmy', favourites: ['sport'] });
        yield table.insert({ name: 'Vanek ur', favourites: ['sport', 'food'] });
    ...
    it("Upsert - with column names", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Upsert - with primary key", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Upsert - with constraint name", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("UpsertAndGet - with constraint name", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Ignore field with undefined value if requested, but keep with null value", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test return only column values ", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test count ", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', membership: 'gold' });
        yield table.insert({ name: 'B', membership: 'gold' });
        yield table.insert({ name: 'C', membership: 'bronze' });
    ...
    it("Test AND - OR ", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test insert with switched fields", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test named parameters ", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', membership: 'gold' });
        yield table.insert({ name: 'B', membership: 'gold' });
        yield table.insert({ name: 'C', membership: 'bronze' });
        let res = yield pgdb.query("SELECT count(*) FROM :!schema.:!table WHERE membership = :membership", {
    ...
    it("text[]", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("integer[]", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("bigInt[]", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("bigInt[] cursor callback", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', bigNumberList: [1, 2, 3] });
        let res;
    ...
    it("timestamptz[]", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({
            name: 'A',
    ...
    it("timestamp and timestamptz", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({
            name: 'A',
    ...
    it("transaction - rollback", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A' });
        let res;
    ...
    it("transaction - savepoint - rollback", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("transaction should keep the table definitions", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const pgDB = pgdb;
    ...
    it("transaction - commit", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A' });
        let pgdbwt = yield pgdb.transactionBegin();
        let tablewt = pgdbwt.schemas[schema]['users'];
        yield tablewt.insert({ name: 'B' });
    ...
    it("transaction - error + rollback", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
    ...
    it("cursor with callback", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', numberList: [1, 2, 3] });
        yield table.insert({ name: 'B' });
    ...
    it("stream - auto connection handling - normal", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let counter = 0;
    ...
    it("stream - auto connection handling - early close", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let counter = 0;
    ...
    it("stream - auto connection handling - error", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let counter = 0;
    ...
    it("stream - with transactions handling - normal", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        let tablewt = pgdbwt[schema]['users'];
    ...
    it("stream - with transactions handling - early close", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        let tablewt = pgdbwt[schema]['users'];
        yield tablewt.insert({ name: 'A', numberList: [1, 2, 3] });
        yield tablewt.insert({ name: 'B' });
    ...
    it("stream - with transactions handling - error", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        let tablewt = pgdbwt[schema]['users'];
    ...
    it("truncate", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A' });
        yield table.insert({ name: 'B' });
    ...
    it("truncate + special types", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield pgdb.setTypeParser('permissionForResourceType', (val) => parseComplexType(val));
        yield pgdb.setTypeParser('_permissionForResourceType', (val) => val == "{}" ? [] : parseComplexTypeArray(val));
        yield table.insert({
            name: 'Piszkos Fred',
    ...
    it("truncate - cascade", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("orderBy", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("stored proc", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', membership: 'gold' });
        yield table.insert({ name: 'B', membership: 'gold' });
    ...
    it("executing sql file - if there is an exception, should be thrown", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    it("select/update/delete should throw exception if the condition contains undefined value", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', membership: 'gold' });
    ...
    it("Testing deleteAndGet ", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A' });
    ...
    it("Testing postprocess function", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A' });
    ...
    it("Testing sql execution", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield pgdb.execute('src/test/tricky.sql', (cmd) => cmd.replace(/__SCHEMA__/g, '"' + schema + '"'));
    }));
    it("Testing text array parsing", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing jsonb array parsing", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let list = [{
                "id": "fl1ace84f744",
    ...
    it("Testing distinct", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
    ...
    it("Testing queryOne", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        yield table.insert({ name: 'B', aCategory: 'A' });
        try {
    ...
    it("Testing queryFirst", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        yield table.insert({ name: 'B', aCategory: 'A' });
        let rec = yield table.queryFirst(`SELECT * FROM ${table} WHERE "aCategory" = 'A'`);
        expect(rec.aCategory).toEqual('A');
    }));
    it("Testing forUpdate", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
    ...
    it("Testing update where something is null", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        yield table.update({ textList: null }, { name: 'B' });
        let rec = yield table.findFirst({ aCategory: 'A' });
        expect(rec.name).toEqual('B');
    }));
    it("Testing query with array equals", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        yield table.insert({ name: 'B', aCategory: 'A' });
    ...
    it("Testing query with array not equals", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        yield table.insert({ name: 'B', aCategory: 'A' });
        yield table.insert({ name: 'C', aCategory: 'A' });
        let recs = yield table.find({ '"name" !=': ['A', 'B'] });
    ...
    it("Testing empty result with one field", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let recs = yield table.queryOneColumn(`select name from ${table}`);
        expect(recs.length).toEqual(0);
    }));
    it("Testing empty result with one column", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let rec = yield table.queryOneField(`select name from ${table}`);
        expect(rec).toEqual(null);
    }));
    it("Testing NOTIFY and LISTEN (listen)", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let called = null;
        let payload = 'hello';
    ...
    it("Testing NOTIFY and LISTEN (unlisten)", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let called = null;
        let payload = 'hello';
        yield table.db.listen('test_channel', (notification) => called = notification.payload);
    ...
    it("Testing Empty 'or' condition", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        let recs = yield table.find({ or: [] });
        expect(recs.length).toEqual(1);
    }));
    it("Testing Empty 'and' condition", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
        let recs = yield table.find({ and: [] });
        expect(recs.length).toEqual(1);
    }));
    it("Testing row mode", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield table.insert({ name: 'A', aCategory: 'A' });
    ...
    it("Testing output formats of default types", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing output formats of enum types - query", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
    ...
    it("Testing output formats of enum types - queryWithOnCursorCallback without stop", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum types - queryWithOnCursorCallback with stop", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum types - queryAsStream", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum array types - query", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
    ...
    it("Testing output formats of enum array types - queryWithOnCursorCallback without stop", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumArrayTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum array types - queryWithOnCursorCallback with stop", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumArrayTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum array types - queryAsStream", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumArrayTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
    ...
    it("Testing output formats of enum array types - query on view", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        let pgdbwt = yield pgdb.transactionBegin();
        yield pgdbwt.run(`DROP TYPE IF EXISTS ${schema}.mood CASCADE`);
        yield pgdbwt.run(`DROP TABLE IF EXISTS ${schema}."enumArrayTable"`);
        yield pgdbwt.run(`CREATE TYPE ${schema}.mood AS ENUM ('sad', 'ok', 'happy')`);
