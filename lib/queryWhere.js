    ...
    if (fieldAndOperator.operator === '@@') {
        ...
        if (typeof value == 'object') {
            ...
            if (fieldType == pgDb_1.FieldType.TSVECTOR) {
                ...
                result.predicates.push(util.format(template, fieldAndOperator.quotedField, fieldAndOperator.operator, result.params.length - 1 + result.offset, //lang
                ...
                result.predicates.push(util.format(template, result.params.length - 2 + result.offset, //lang
                fieldAndOperator.quotedField, fieldAndOperator.operator, result.params.length - 1 + result.offset, //lang
                result.params.length + result.offset //query
                ));
            }
        }
