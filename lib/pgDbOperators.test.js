...
describe("pgdb", () => {
    ...
    it("Testing Array operators", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing Array operators on view", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Searching in elements in jsonList", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Free text search", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing Jsonb list selector operators", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing Jsonb list update", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield tableUsers.insert({ name: 'Somebody', jsonList: ['sport', 'season'] });
    ...
    it("Testing Jsonb list operators", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test deep jsonb @>", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Testing is (not) null", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield tableUsers.insert({ name: 'Noone', jsonObject: null });
        yield tableUsers.insert({ name: 'Anonymous', jsonObject: {} });
        let count;
    ...
    it("Test regexp ~,~*,!~,!~*", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test regexp " +
        "~/~* ANY" +
        "!~/!~* ALL", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield tableUsers.insert({ name: "All' o Phoibe" });
        yield tableUsers.insert({ name: "I've got that tune" });
    ...
    it("Test like ~~, like, ~~*, ilike, !~~, not like, !~~*, not ilike", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Test " +
        "like/~~/ilike/~~* ANY(), " +
        "not like/!~~/not ilike/!~~* ALL()", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield tableUsers.insert({ name: 'Iced lemonade' });
        yield tableUsers.insert({ name: 'Cucumber pear juice' });
        let res;
    ...
    it("Special added operators =*, icontains", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield tableUsers.insert({ name: 'Iced lemonade' });
