        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (connection) {
                    ...
                    pgUtils_1.pgUtils.convertTypes(res.rows, res.fields, this.db.pgdbTypeParsers);
                    return res.rows;
                } else {
                ...
                try {
                    if (connection) {
                        ...
                        yield new Promise((resolve, reject) => {
                            stream.on('data', res => {
                                try {
                                    pgUtils_1.pgUtils.convertTypes([res], stream._result.fields, this.db.pgdbTypeParsers);
                                    callback(res);
                                } catch (e) {
                                    reject(e);
                                }
    ...
    queryAsStream(sql, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let convertTypeFilter = through(function (data) {
                try {
                    pgUtils_1.pgUtils.convertTypes([data], pgStream._result.fields, pgdb.pgdbTypeParsers);
                    this.emit('data', data);
                } catch (err) {
                    this.emit('error', err);
                }
