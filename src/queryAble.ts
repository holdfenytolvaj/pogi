...
export class QueryAble {
    ...
    async queryWithOnCursorCallback(sql: string, params: any[],  callback:(any)=>void): Promise<void>
    async queryWithOnCursorCallback(sql: string, params: Object, callback:(any)=>void): Promise<void>
    async queryWithOnCursorCallback(sql: string, params: any,    callback:(any)=>void): Promise<void> {
        let connection = this.db.connection;
    ...
    async queryAsStream(sql: string, params?: any[],  options?:SqlQueryOptions): Promise<Readable>
    async queryAsStream(sql: string, params?: Object, options?:SqlQueryOptions): Promise<Readable>
    async queryAsStream(sql: string, params?: any,    options?:SqlQueryOptions): Promise<Readable> {
        let connection = this.db.connection;
        let logger = (options && options.logger || this.getLogger(false));
    ...
    async queryOneField(sql: string, params?: Object, options?:SqlQueryOptions): Promise<any>
    async queryOneField(sql: string, params?: any, options?:SqlQueryOptions): Promise<any> {
    ...
    async queryOneColumn(sql: string, params?: Object, options?:SqlQueryOptions): Promise<any[]>
    async queryOneColumn(sql: string, params?: any, options?:SqlQueryOptions): Promise<any[]> {
        let res = await this.query(sql, params, options);
        let fieldName = Object.keys(res[0])[0];
